...
gnutls_anon_set_server_params_function.argtypes = [gnutls_anon_server_credentials_t, POINTER(gnutls_params_function)]
...
gnutls_srp_set_server_credentials_function.argtypes = [gnutls_srp_server_credentials_t, POINTER(gnutls_srp_server_credentials_function)]
...
gnutls_srp_set_client_credentials_function.argtypes = [gnutls_srp_client_credentials_t, POINTER(gnutls_srp_client_credentials_function)]
...
gnutls_psk_set_server_credentials_function.argtypes = [gnutls_psk_server_credentials_t, POINTER(gnutls_psk_server_credentials_function)]
...
gnutls_psk_set_client_credentials_function.argtypes = [gnutls_psk_client_credentials_t, POINTER(gnutls_psk_client_credentials_function)]
...
gnutls_psk_set_server_params_function.argtypes = [gnutls_psk_server_credentials_t, POINTER(gnutls_params_function)]
...
gnutls_certificate_client_set_retrieve_function.argtypes = [gnutls_certificate_credentials_t, POINTER(gnutls_certificate_client_retrieve_function)]
...
gnutls_certificate_server_set_retrieve_function.argtypes = [gnutls_certificate_credentials_t, POINTER(gnutls_certificate_server_retrieve_function)]
...
gnutls_certificate_set_params_function.argtypes = [gnutls_certificate_credentials_t, POINTER(gnutls_params_function)]
...
gnutls_anon_set_params_function.argtypes = [gnutls_anon_server_credentials_t, POINTER(gnutls_params_function)]
...
gnutls_psk_set_params_function.argtypes = [gnutls_psk_server_credentials_t, POINTER(gnutls_params_function)]
