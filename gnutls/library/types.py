...
gnutls_authz_recv_callback_func = CFUNCTYPE(c_int, POINTER(gnutls_session_int), POINTER(c_int), POINTER(gnutls_datum_t), POINTER(c_int), POINTER(gnutls_datum_t))
gnutls_authz_send_callback_func = CFUNCTYPE(c_int, POINTER(gnutls_session_int), POINTER(c_int), POINTER(c_int))
...
gnutls_sign_func = CFUNCTYPE(c_int, POINTER(gnutls_session_int), c_void_p, gnutls_certificate_type_t, POINTER(gnutls_datum_t), POINTER(gnutls_datum_t), POINTER(gnutls_datum_t))
...
__all__ = ['gnutls_transport_ptr_t', 'gnutls_session_int',
           ...
           'gnutls_openpgp_trustdb_int', 'key', '__ssize_t',
           ...
           'gnutls_authz_send_callback_func', 'gnutls_dh_params_t',
